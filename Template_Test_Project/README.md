...
<h3 align="center">Template_Test_Project</h3>
...
This is a template test  project which is created under a new branch named test_template.
...
### Clone the project 
```
git clone git@github.com:LIFENGZI1015/ds_template.git
```

## Setup your environement and install project dependencies
```
conda create -n Template_Test_Project python=3.9
source activate Template_Test_Project
...
##  ✍️ Authors
LIFENGZI1015 - test@mydomain.com